...
////	private double durer=-1;
    ...
    String Create(@RequestParam double prixMin, @RequestParam String dateDebut,
            @PathVariable int id, @RequestParam int categorieId,
            @RequestParam String descProduit, @RequestParam double durer) throws Exception {
...
//        }
        try {
            ...
            enchere.setDescProduit(descProduit);
