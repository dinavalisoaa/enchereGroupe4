...
//
//        g.drawString("Couche par proportion", 840, 50);
...
//        yPiste1 = new int[li.size()];
//        int cpt = 0;
//        value = Couche1.TriMontant(value);
//        for (int i = 0; i < value.length; i++) {
//            PointSource val = value[i];
//            xPiste1[cpt] = (int) val.getPosX() + 840;
//            yPiste1[cpt] = (int) val.getPosY();
//            g.drawString(val.getNom()+" "+Double.toString(val.getBene()) + "g/h", xPiste1[i] - 150, yPiste1[i] - 10);
