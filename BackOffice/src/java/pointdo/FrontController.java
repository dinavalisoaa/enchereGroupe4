...
// * @author dina
// */
//@WebServlet(name = "FrontController", urlPatterns = {"*.da"})
...
//            String url = Utilitaire.retrieveUrlFromRawUrl(request);
//            out.println(url);
...
//                                    argument = Integer.parseInt(request.getParameter(names));
...
//                    }
//                    HashMap<String, Object> map = load.getData();
//                    out.println(load.getPage());
//                    if (!load.session.isEmpty()) {
//                        if (load.session.isDestroy() == true) {
//                            out.println("----");//load.session.getAttributes("karen"));
...
// out.println("" + "==");
//                        response.sendRedirect(load.getRedirect());
//                    } else {
//                        RequestDispatcher dispatcher = request.getRequestDispatcher("" + load.getPage());
